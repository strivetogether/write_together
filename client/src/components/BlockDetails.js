...
export default class BlockDetails extends Component {
    ...
    handleSubmit = (event) => {
        ...
        axios
            .post(`/api/blocks/details/${id}/addidea`, {
            ...
            <div className="d-flex justify-content-around">
                <div className="postitrow">
                    <section className="postit">
                        <ul>
                            {this.state.block.ideas
                                .filter((idea, index) => index % 2 !== 0)
                                .map((idea) => {
                                    return (
                                        <li
                                            key={idea._id}
                ...
                <div class="letterrow">
                    <section className="blockdetails">
                        <div className="letter-wrapper">
                            <div className="letter letter-blockdetails">
                                <h1 className="cormorant">
                                    {this.state.title}
                                </h1>
                                <Interweave content={this.state.text} />
                                <h2 className="questionmarker">
                                ...
                                {isOwner && (
                                    <div>
                                        <Button onClick={this.handleGoToEdit}>
                                            Edit
                                        </Button>
                                        <span>&nbsp;</span>
                                        <Button
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Group>
                                <Form.Label htmlFor="text">
                                    <h2 class="addidea">Share your idea</h2>
                                </Form.Label>
                                <Editor
